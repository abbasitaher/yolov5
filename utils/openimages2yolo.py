...
images_src = '/home/atefeh/data/Open Images Dataset V6/train/'
labels_dst = '/home/atefeh/data/yolo_proxeye/train/'
images_dst = '/home/correct-ai/data/proxeye_yolo/images/'
...
def SaveBoundingBoxToFile(image_id,label,x_min,x_max,y_min,y_max):
    ...
    if os.path.isfile(os.path.join(images_src, image_id + '.jpg')):
        ...
        if os.path.isfile(labels_dst + image_id + '.txt'):
...
if __name__ == '__main__':
    ...
    dataset_csv = '/home/atefeh/data/Open Images Dataset V6/train-annotations-bbox.csv'
    classes_csv = '/home/atefeh/data/Open Images Dataset V6/class-descriptions-boxable.csv'
    ...
    for img in tqdm(images):
        ...
        shutil.copyfile(img, os.path.join(images_dst, prefix + img_name))
